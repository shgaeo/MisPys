...
def make_constant_model(prefix=None):
    ...
    if not isinstance(prefix, str) and prefix is not None:
        log.error('The passed prefix <{0}> of type {1} is not a string and cannot be used as '
...
def make_slope_model(prefix=None):
...
def make_linear_model(prefix=None):
    """ Create linear model.
    ...
    slope, slope_param = make_slope_model(prefix=prefix)
    constant, constant_param = make_constant_model(prefix=prefix)
...
def make_linear_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    linear, params = make_linear_model()

    error, params = estimator(x_axis, data, params)

    params = _substitute_params(initial_params=params, update_params=add_params)
...
def estimate_linear(x_axis, data, params):
    ...
    error = _check_1D_input(x_axis=x_axis, data=data, params=params)
    ...
    try:
        ...
        log.warning('The estimation for linear fit did not work.')
