...
from lens.fit_testing.helpers import compute_ft
import lens.fit_testing.general_fit_methods as gfm
import lens.fit_testing.linear_fit_methods as lfm
...
def make_baresine_model(prefix=None):
    ...
    if not isinstance(prefix, str) and prefix is not None:
        print('The passed prefix <{0}> of type {1} is not a string and'
...
def make_sinewithoutoffset_model(prefix=None):
    ...
    """
    baresine_model, params = make_baresine_model(prefix=prefix)
    amplitude_model, params = lfm.make_amplitude_model(prefix=prefix)
...
def make_sine_model(prefix=None):
    ...
    sine_model, params = make_sinewithoutoffset_model(prefix=prefix)
    constant_model, params = lfm.make_constant_model(prefix=prefix)
...
def make_sineexpdecaywithoutoffset_model(prefix=None):
    ...
    sine_model, params = make_sinewithoutoffset_model(prefix=prefix)
    bareexponentialdecay_model, params = dfm.make_bareexponentialdecay_model(prefix=prefix)
...
def make_sineexponentialdecay_model(prefix=None):
    ...
    sine_exp_decay_model, params = make_sineexpdecaywithoutoffset_model(prefix=prefix)
    constant_model, params = lfm.make_constant_model(prefix=prefix)
...
def make_sinestretchedexponentialdecay_model(prefix=None):
    ...
    sine_model, params = make_sinewithoutoffset_model(prefix=prefix)
    bare_stretched_exp_decay_model, params = dfm.make_barestretchedexponentialdecay_model(prefix=prefix)
    constant_model, params = lfm.make_constant_model(prefix=prefix)
...
def make_sinedouble_model(prefix=None):
    ...
    sine_model1, params = make_sinewithoutoffset_model(prefix='s1_'+add_text)
    sine_model2, params = make_sinewithoutoffset_model(prefix='s2_'+add_text)
...
def make_sinedoublewithexpdecay_model(prefix=None):
    ...
    sine_model1, params = make_sinewithoutoffset_model(prefix='s1_'+add_text)
    sine_model2, params = make_sinewithoutoffset_model(prefix='s2_'+add_text)
    bare_exp_decay_model, params = dfm.make_bareexponentialdecay_model(prefix=prefix)
...
def make_sinedoublewithtwoexpdecay_model(prefix=None):
    ...
    sine_exp_decay_model1, params = make_sineexpdecaywithoutoffset_model(prefix='e1_'+add_text)
    sine_exp_decay_model2, params = make_sineexpdecaywithoutoffset_model(prefix='e2_'+add_text)
...
def make_sinetriple_model(prefix=None):
    ...
    sine_model1, params = make_sinewithoutoffset_model(prefix='s1_'+add_text)
    sine_model2, params = make_sinewithoutoffset_model(prefix='s2_'+add_text)
    sine_model3, params = make_sinewithoutoffset_model(prefix='s3_'+add_text)
...
def make_sinetriplewithexpdecay_model(prefix=None):
...
def make_sinetriplewiththreeexpdecay_model(prefix=None):
    ...
    sine_exp_decay_model1, params = make_sineexpdecaywithoutoffset_model(prefix='e1_'+add_text)
    sine_exp_decay_model2, params = make_sineexpdecaywithoutoffset_model(prefix='e2_'+add_text)
    sine_exp_decay_model3, params = make_sineexpdecaywithoutoffset_model(prefix='e3_'+add_text)
...
def estimate_baresine(x_axis, data, params):
    ...
    error = gfm._check_1D_input(x_axis=x_axis, data=data, params=params)
...
def estimate_sinewithoutoffset(x_axis, data, params):
    ...
    for tries, diff_array_step in enumerate(diff_array):
        if np.isclose(min_x_diff, 0.0, atol=1e-12):
            ...
            if len(diff_array) == 0:
                print('The passed x_axis for the sinus estimation contains the same values! Cannot do the fit!')
                return -1, params
            else:
                min_x_diff = diff_array.min()
            break
...
def make_sine_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    sine, params = make_sine_model()

    error, params = estimator(x_axis, data, params)

    params = gfm._substitute_params(initial_params=params,
                                     update_params=add_params)
    try:
        result = sine.fit(data, x=x_axis, params=params, **kwargs)
    except:
        result = sine.fit(data, x=x_axis, params=params, **kwargs)
        print('The sine fit did not work.\n'
    ...
    result_str_dict['Phase'] = {'value': 180/np.pi*result.params['phase'].value,
                                'error': 180/np.pi*result.params['phase'].stderr if result.params['phase'].stderr
                                         else 0.0,
                                'unit': 'deg'}
...
def estimate_sine(x_axis, data, params):
    ...
    error, params = estimate_sinewithoutoffset(x_axis=x_axis, data=data_level, params=params)
...
def make_sineexponentialdecay_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    sine_exp_decay_offset, params = make_sineexponentialdecay_model()
    ...
    try:
        ...
        result = sine_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
        print('The sineexponentialdecayoffset fit did not work.\n'
...
def estimate_sineexponentialdecay(x_axis, data, params=None):
...
def make_sinestretchedexponentialdecay_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    sine_stretched_exp_decay, params = make_sinestretchedexponentialdecay_model()
    ...
    try:
        ...
        result = sine_stretched_exp_decay.fit(data, x=x_axis, params=params, **kwargs)
        print('The sineexponentialdecay fit did not work.\n'
                       'Error message: {0}'.format(result.message))
...
def estimate_sinestretchedexponentialdecay(x_axis, data, params):
    ...
    error, params = estimate_sineexponentialdecay(x_axis, data, params)
...
def make_sinedouble_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    two_sine_offset, params = make_sinedouble_model()
    ...
    try:
        ...
        print('The twosineexpdecayoffset fit did not work. '
...
def estimate_sinedouble(x_axis, data, params):
    ...
    result1 = make_sine_fit(x_axis=x_axis, data=data, estimator=estimate_sine)
    data_sub = data - result1.best_fit

    result2 = make_sine_fit(x_axis=x_axis, data=data_sub, estimator=estimate_sine)
...
def make_sinedoublewithexpdecay_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    two_sine_exp_decay_offset, params = make_sinedoublewithexpdecay_model()
    ...
    try:
        ...
        print('The sinedoublewithexpdecay fit did not work. '
                         'Error message: {}'.format(str(result.message)))
        result = two_sine_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
...
def estimate_sinedoublewithexpdecay(x_axis, data, params):
    ...
    result1 = make_sineexponentialdecay_fit(
        x_axis=x_axis,
        data=data,
        estimator=estimate_sineexponentialdecay)
    data_sub = data - result1.best_fit

    result2 = make_sineexponentialdecay_fit(
        x_axis=x_axis,
        data=data_sub,
        estimator=estimate_sineexponentialdecay)
...
def make_sinedoublewithtwoexpdecay_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    two_sine_two_exp_decay_offset, params = make_sinedoublewithtwoexpdecay_model()
    ...
    try:
        ...
        print('The sinedoublewithtwoexpdecay fit did not work. '
                         'Error message: {}'.format(str(result.message)))
        result = two_sine_two_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
...
def estimate_sinedoublewithtwoexpdecay(x_axis, data, params):
    """ Provides an estimator for initial values of two sine with offset and
...
def make_sinetriple_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    two_sine_offset, params = make_sinetriple_model()
    ...
    try:
        ...
        print('The threesineexpdecayoffset fit did not work. '
                         'Error message: {}'.format(str(result.message)))
        result = two_sine_offset.fit(data, x=x_axis, params=params, **kwargs)
...
def estimate_sinetriple(x_axis, data, params):
    ...
    res1 = make_sine_fit(x_axis=x_axis, data=data, estimator=estimate_sine)
    data_sub1 = data - res1.best_fit

    res2 = make_sine_fit(x_axis=x_axis, data=data_sub1, estimator=estimate_sine)
    data_sub2 = data_sub1 - res2.best_fit

    res3 = make_sine_fit(x_axis=x_axis, data=data_sub2, estimator=estimate_sine)
...
def make_sinetriplewithexpdecay_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    three_sine_exp_decay_offset, params = make_sinetriplewithexpdecay_model()

    error, params = estimator(x_axis, data, params)

    params = gfm._substitute_params(initial_params=params, update_params=add_params)
    try:
        result = three_sine_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
    except:
        print('The sinetriplewithexpdecay fit did not work. '
                         'Error message: {}'.format(str(result.message)))
        result = three_sine_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
...
def estimate_sinetriplewithexpdecay(x_axis, data, params):
    ...
    res1 = make_sineexponentialdecay_fit(
        x_axis=x_axis,
        data=data,
        estimator=estimate_sineexponentialdecay)
    ...
    res2 = make_sineexponentialdecay_fit(
        x_axis=x_axis,
        data=data_sub1,
        estimator=estimate_sineexponentialdecay)
    ...
    res3 = make_sineexponentialdecay_fit(
        x_axis=x_axis,
        data=data_sub2,
        estimator=estimate_sineexponentialdecay)
...
def make_sinetriplewiththreeexpdecay_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    three_sine_three_exp_decay_offset, params = make_sinetriplewiththreeexpdecay_model()
    ...
    try:
        ...
        print('The twosinetwoexpdecayoffset fit did not work. '
                         'Error message: {}'.format(str(result.message)))
        result = three_sine_three_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
...
def estimate_sinetriplewiththreeexpdecay(x_axis, data, params):
    """ Provides an estimator for initial values of three sine with offset and
