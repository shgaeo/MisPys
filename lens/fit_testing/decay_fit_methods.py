...
def make_barestretchedexponentialdecay_model(prefix=None):
...
def make_bareexponentialdecay_model(prefix=None):
    ...
    bare_exp_decay, params = make_barestretchedexponentialdecay_model(prefix=prefix)
...
def make_decayexponential_model(prefix=None):
    ...
    bare_exp_model, params = make_bareexponentialdecay_model(prefix=prefix)
...
def make_decayexponentialstretched_model(prefix=None):
    ...
    bare_stre_exp_decay, params = make_barestretchedexponentialdecay_model(prefix=prefix)
    amplitude_model, params = lfm.make_amplitude_model()
    constant_model, params = lfm.make_constant_model(prefix=prefix)
...
def make_decayexponential_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    """
    exponentialdecay, params = make_decayexponential_model()
    ...
    try:
        ...
        result = exponentialdecay.fit(data, x=x_axis, params=params, **kwargs)
        print('The exponentialdecay with offset fit did not work. '
...
def estimate_decayexponential(x_axis, data, params):
    ...
    try:
        ...
        linear_result = lfm.make_linear_fit(x_axis=x_axis[0:i], data=data_level_log, estimator=lfm.estimate_linear)
        ...
        print('Lifetime too small in estimate_exponentialdecay, beyond resolution!')
...
def make_decayexponentialstretched_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    @return object result: lmfit.model.ModelFit object, all parameters
                           ...
                           with best fit with given axis,...
    """
    stret_exp_decay_offset, params = make_decayexponentialstretched_model()
    ...
    try:
        ...
        result = stret_exp_decay_offset.fit(data, x=x_axis, params=params, **kwargs)
        print('The double exponentialdecay with offset fit did not work. '
                       'Message: {}'.format(str(result.message)))
