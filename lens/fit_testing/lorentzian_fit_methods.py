...
import lens.fit_testing.linear_fit_methods as linfm
...
def make_lorentzianwithoutoffset_model(prefix=None):
    ...
    amplitude_model, params = linfm.make_amplitude_model(prefix=prefix)
...
def make_lorentzian_model(prefix=None):
    ...
    lorentz_model, params = make_lorentzianwithoutoffset_model(prefix=prefix)
    constant_model, params = linfm.make_constant_model(prefix=prefix)
...
def make_multiplelorentzian_model(no_of_functions=1):
    ...
    if no_of_functions == 1:
        ...
        constant_model, params = linfm.make_constant_model()
...
def make_lorentziantriple_model():
    ...
    return make_multiplelorentzian_model(no_of_functions=3)
...
def make_lorentzian_fit(x_axis, data, estimator, units=None,
    ...
    model, params = make_lorentzian_model()
    ...
    try:
        ...
        result = model.fit(data, x=x_axis, params=params, **kwargs)
        print('The 1D lorentzian fit did not work. Error '
...
def estimate_lorentzian_dip(x_axis, data, params):
    ...
    data_smooth, offset = gfm.find_offset_parameter(x_axis, data)
...
def estimate_lorentzian_peak (x_axis, data, params):
    ...
    error, params_ret = estimate_lorentzian_dip(
        x_axis,
        data_negative,
        params_dip)
...
def make_lorentziandouble_fit(x_axis, data, estimator, units=None, add_params=None, **kwargs):
    ...
    model, params = make_lorentziandouble_model()
    ...
    try:
        ...
        result = model.fit(data, x=x_axis, params=params, **kwargs)
        print('The double lorentzian fit did not '
...
def estimate_lorentziandouble_dip(x_axis, data, params,
    ...
    ret_val = gfm._search_double_dip(x_axis, data_level, threshold_fraction,
                                      minimal_threshold,
...
def estimate_lorentziandouble_peak(x_axis, data, params,
                                   threshold_fraction=0.3,
                                   minimal_threshold=0.01,
                                   sigma_threshold_fraction=0.3):
    ...
    error, params_ret = estimate_lorentziandouble_dip(x_axis,
                                                           data_negative,
                                                           params_dip)
...
def estimate_lorentziandouble_N15(x_axis, data, params):
    ...
    if length_x_scan < hf_splitting/2 or hf_splitting > 1e9:
        print('The N15 estimator expects an x_axis with a length in the '
    ...
    data_smooth_lorentz, offset = gfm.find_offset_parameter(x_axis, data)
...
def make_lorentziantriple_fit(x_axis, data, estimator, units=None,
                            add_params=None, **kwargs):
    ...
    model, params = make_lorentziantriple_model()
    ...
    try:
        ...
        result = model.fit(data, x=x_axis, params=params, **kwargs)
        print('The triple lorentzian fit did not '
                       'work: {0}'.format(result.message))
...
def estimate_lorentziantriple_N14(x_axis, data, params):
    ...
    if length_x_scan < hf_splitting/2 or hf_splitting > 1e9:
        print('The N14 estimator expects an x_axis with a length in the '
                     'range [{0},{1}]Hz, but the passed x_axis has a length of '
